...
const _offsetsTableAmiga = Uint16Array.from([
...
const _amigaDemoOffsetsTable = Uint8Array.from([
	1, 32, 0, /* HOLOCUBE */
	6, 33, 0, /* CHUTE2 */
	255
])
...
const _creditsDataAmiga = Uint8Array.from([
...
const _frTextsTable = [
	{ num: 1, str: "VOUS RAMASSEZ L'HOLOCUBE" },
	{ num: 2, str: "VOUS RAMASSEZ LA CLE" },
	{ num: 4, str: "VOUS RAMASSEZ LE PISTOLET" },
	{ num: 5, str: "VOTRE BOUCLIER EST RECHARGE" },
	{ num: 10, str: "VOUS RAMASSEZ||LA CARTE DE CREDITS" },
	{ num: 14, str: "LA PILE EST RECHARGEE" },
	{ num: 15, str: "VOUS RAMASSEZ LA PILE" },
	{ num: 16, str: "VOUS RAMASSEZ LE TELEPORTEUR" },
	{ num: 18, str: "VOUS RAMASSEZ LA CARTE ID" },
	{ num: 21, str: "VOUS LUI DONNEZ LE TELEPORTEUR" },
	{ num: 32, str: "LA RECEPTIONNISTE VOUS DONNE||UN PAQUET" },
	{ num: 33, str: "VOUS DONNEZ LE COLIS" },
	{ num: 34, str: "LE GOUVERNEUR VOUS DONNE||LA CARTE DE TRAVAIL" },
	{ num: 35, str: "LE FAUSSAIRE VOUS DONNE||LA FAUSSE CARTE ID" },
	{ num: 36, str: "VOUS RAMASSEZ LE FUSIBLE" },
	{ num: 43, str: "VOUS LUI TENDEZ||VOS PAPIERS" },
	{ num: 44, str: "VOUS LUI DONNEZ L'ARGENT" },
	{ num: 49, str: "IL VOUS DONNE||UNE CEINTURE ANTI-G" },
	{ num: 60, str: "VOUS RAMASSEZ LE TELE RECEPTEUR" },
	{ num: -1, str: null }
]
...
const _stringsTableFR = Uint8Array.from([
...
const _stringsTableDE = Uint8Array.from([
...
const _stringsTableSP = Uint8Array.from([
...
const _stringsTableIT = Uint8Array.from([
...
const _stringsTableJP = Uint8Array.from([
...
const _level1TbnJP = Uint8Array.from([
...
const _level2TbnJP = Uint8Array.from([
...
const _level3TbnJP = Uint8Array.from([
...
const _level41TbnJP = Uint8Array.from([
...
const _level42TbnJP = Uint8Array.from([
...
const _level51TbnJP = Uint8Array.from([
...
const _level52TbnJP = Uint8Array.from([
...
const _cineBinJP = Uint8Array.from([
...
const _cineTxtJP = Uint8Array.from([
...
const _font8Jp = Uint8Array.from([
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const _flagFr16x12 = Uint8Array.from([
...
const _flagDe16x12 = Uint8Array.from([
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
const _flagIt16x12 = Uint8Array.from([
...
const _flagJp16x12 = Uint8Array.from([
...
const _flagSp16x12 = Uint8Array.from([
...
export { _namesTableDOS, _offsetsTableDOS, _offsetsTableAmiga, _amigaDemoOffsetsTable, _ssiOffsetsTable, _cosTable, _sinTable, _creditsDataDOS, _creditsDataAmiga, _creditsCutSeq, _musicTable, _protectionShapeData, _frTextsTable, _enTextsTable, _demoInputs, _gameLevels, scoreTable, _monsterListLevel1, _monsterListLevel2, _monsterListLevel3, _monsterListLevel4_1, _monsterListLevel4_2, _monsterListLevel5_1, _monsterListLevel5_2, _monsterListLevels, _monsterPals, _monsterNames, _stringsTableFR, _stringsTableEN, _stringsTableDE, _stringsTableSP, _stringsTableIT, _stringsTableJP, _gameSavedSoundLen, _textsTableFR, _textsTableEN, _textsTableDE, _textsTableSP, _textsTableIT, _level1TbnJP, _level2TbnJP, _level3TbnJP, _level41TbnJP, _level42TbnJP, _level51TbnJP, _level52TbnJP, _cineBinJP, _cineTxtJP, _voicesOffsetsTable, _spmOffsetsTable, _splNames, _gameSavedSoundData, _pge_modKeysTable, _protectionCodeData, _protectionWordData, _protectionNumberDataAmiga, _protectionCodeDataAmiga, _protectionPal, _levelNames, _passwordsDOS, _passwordsFrAmiga, _passwordsEnAmiga, _passwordsMac, _conradPal1, _conradPal2, _textPal, _palSlot0xF, _font8Jp, _periodTable, _modulesFiles, _namesTable, _musicData68, _musicData70, _musicData72, _musicData73, _musicData74, _musicData75, _musicDataSample1, _musicDataSample2, _musicDataSample3, _musicDataSample4, _musicDataSample5, _musicDataSample6, _musicDataSample7, _musicDataSample8, _module68, _module70, _module72, _module73, _module74, _module75, _sfxPeriodTable, _caillouSetData, _flagEn16x12, _flagFr16x12, _flagDe16x12, _flagIt16x12, _flagJp16x12, _flagSp16x12 }
